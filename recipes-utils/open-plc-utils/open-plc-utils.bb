...
do_compile() {
	# sed -i "s/CC=\$(CROSS)gcc/#CC=\$(CROSS)gcc/g" make.def
	# sed -i "s/STRIP=\$(CROSS)strip/#STRIP=\$(CROSS)strip/g" make.def
	# sed -i "s/LD=\$(CROSS)ld/#LD=\$(CROSS)ld/g" make.def
	# sed -i "s/AR=\$(CROSS)ar/#AR=\$(CROSS)ar/g" make.def
	make
}
